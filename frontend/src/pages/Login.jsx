...
const Login = () => {
  ...
  const demoUsers = [
    { username: 'subadmin', password: 'super123', role: 'Administrador' },
    { username: 'admin', password: 'admin123', role: 'Súper administrador' },
            ...
            {demoUsers.map((user, index) => (
              <button
                ...
                className={`
                  ...
                  ${user.role === 'Administrador' ? 'border-red-200 hover:border-red-400 hover:bg-red-50' : ''}
                  ${user.role === 'Súper administrador' ? 'border-blue-200 hover:border-blue-400 hover:bg-blue-50' : ''}
              ...
              >
                <div className={`
                  ...
                  ${user.role === 'Administrador' ? 'bg-red-100 text-red-600' : ''}
                  ${user.role === 'Súper administrador' ? 'bg-blue-100 text-blue-600' : ''}
                  ${user.role === 'Cobrador' ? 'bg-green-100 text-green-600' : ''}
                  ${user.role === 'Cliente' ? 'bg-purple-100 text-purple-600' : ''}
                `}>
                  {user.role === 'Administrador' && '👑'}
                  {user.role === 'Súper administrador' && '👨‍💼'}
