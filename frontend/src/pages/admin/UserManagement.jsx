...
const UserManagement = () => {
  ...
  const roles = [
    { id: 'admin', name: 'Administrador', icon: Crown, color: 'text-purple-600', bg: 'bg-purple-100' },
    { id: 'subadmin', name: 'Sub-Administrador', icon: ShieldCheck, color: 'text-blue-600', bg: 'bg-blue-100' },
