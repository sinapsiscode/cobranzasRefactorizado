...
const ClientManagement = () => {
  ...
  const [clientFormData, setClientFormData] = useState({
    ...
    paymentDueDays: 5, // Días de gracia antes del vencimiento
    status: 'active',
  ...
  const handleEditClient = (client) => {
    ...
    setEditClientFormData({
      ...
      paymentDueDays: client.paymentDueDays || 5,
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                    />
                    <p className="text-xs text-gray-500 mt-1">Día del mes en que debe pagar (1-31)</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      max="15"
                      value={clientFormData.paymentDueDays}
                      onChange={(e) => handleClientFormChange('paymentDueDays', parseInt(e.target.value))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                    />
                    <p className="text-xs text-gray-500 mt-1">Días después de la fecha de pago antes del vencimiento (1-15)</p>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min="1"
                      max="15"
                      value={editClientFormData.paymentDueDays}
                      onChange={(e) => handleEditClientFormChange('paymentDueDays', parseInt(e.target.value))}
                      className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary"
                    />
                    <p className="text-xs text-gray-500 mt-1">Días después de la fecha de pago antes del vencimiento (1-15)</p>
                  </div>
