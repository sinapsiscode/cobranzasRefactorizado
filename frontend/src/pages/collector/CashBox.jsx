...
const CashBox = () => {
  ...
  const handleRequestCashBox = async () => {
    ...
    try {
      ...
      success('Solicitud de apertura de caja enviada. Espera la aprobación del Sub-Administrador.');
          ...
          {currentRequest ? (
                ...
                <>
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 text-left">
                    ...
                    <p className="text-sm text-yellow-700">
                      Tu solicitud de apertura de caja está siendo revisada por el Sub-Administrador.
            ...
            <>
              <p className="text-gray-600 mb-6">
                Solicita apertura de caja al Sub-Administrador para comenzar a trabajar
              </p>
              <button
                onClick={() => setShowRequestModal(true)}
                className="flex items-center mx-auto px-6 py-3 bg-blue-600 text-white rounded-md font-medium hover:bg-blue-700"
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={2}
                  placeholder="Información adicional para el Sub-Administrador..."
                />
              </div>
