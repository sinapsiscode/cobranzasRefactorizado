    ...
    switch (user?.role) {
      case 'subadmin':
        return [
          ...
          { name: 'Usuarios', href: '/subadmin/users', icon: Shield },
      ...
      case 'admin':
        return [
          ...
          { name: 'Métodos de Pago', href: '/admin/payment-method-management', icon: Smartphone },
      ...
      case 'client':
        return [
          ...
          { name: 'Subir Voucher', href: '/client/upload-voucher', icon: CreditCard },
        ];
      default:
        return [];
    }
