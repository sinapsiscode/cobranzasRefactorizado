...
const CollectorManagement = () => {
  ...
  const handleConfirmSendReminder = () => {
    try {
      ...
      success(`Recordatorio de cierre de caja enviado a ${collectorNames}`);
            ...
            <div className="mb-4">
              ...
              <div className="bg-gray-50 rounded-lg p-3 max-h-32 overflow-y-auto">
                {selectedCollectors.map(collectorId => {
                  ...
                  return collector ? (
                    <div key={collectorId} className="text-sm text-gray-700 py-1">
            ...
            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-3 mb-4">
              <div className="flex items-start">
                ...
                <div className="text-sm text-yellow-800">
                  ...
                  <p>Este recordatorio aparecerá como popup persistente para los cobradores hasta que lo confirmen.</p>
                </div>
              </div>
            </div>
